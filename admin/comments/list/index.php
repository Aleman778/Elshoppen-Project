<?php 
    ...
    if ($filter != "") {
        ...
        echo $user . " - " . $product . " - " . $reply . " => " . $search;
    }
                ...
                <table class="table" style=" border-bottom: 1px solid #dee2e6;">
                    ...
                    <tbody>
                        <?php foreach($comments as $comment) { ?>
                            ...
                            <!-- Modal -->
                            <?php if ($deleteAccess) { ?>
                                <div class="modal fade" id="deleteProduct<?php echo $comment["COMMENTS.id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteProductModal<?php echo $item["id"]; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteProductModal<?php echo $comment["COMMENTS.id"]; ?>">Är du säker på att du vill radera kommentaren?</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete.php?id=<?php echo $comment["COMMENTS.id"]; ?>" type="button" class="btn btn-danger">Radera</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
